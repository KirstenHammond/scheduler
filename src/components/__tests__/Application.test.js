...
import { render, getByText, getByTestId, getAllByTestId, prettyDOM, cleanup, waitForElement, fireEvent, getByAltText, getByPlaceholderText, queryByText, queryByAltText } from "@testing-library/react";
...
describe("Application component tests", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    // 4. Check that the edit mode is shown.
    expect(
